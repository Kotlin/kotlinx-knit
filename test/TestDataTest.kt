...
class TestDataTest {
    ...
    // !!! AUTOMATICALLY GENERATED BY TestDataGen. DO NOT EDIT !!!
    @Test
    fun testExampleIndented() {
       verifyTestData(
           "ExampleIndented",
           "testdata/example-indented.in.md",
           "testdata/example-indented.in.md",
           "testdata/example-indented.properties",
           FileRef.Expect("testdata/example-indented/example-indented-01.kt")
       )
    }
