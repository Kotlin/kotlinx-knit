...
//private val TEST_DATA_DIR = System.getProperty("TEST_DATA_DIR").let {
//    println("TEST_DATA_DIR $it")
//    Paths.get(it)
//}

val TEST_DATA_DIR  = Paths.get(object {}::class.java.getResource("testdata")!!.toURI())
//= run {
//    println("current path ${Paths.get(".").absolutePathString()}")
//    val x = Paths.get("testdata").absolute()
//    println("test data $x")
//    x
//}
