        ...
        mainLoop@ while (true) {
            ...
            when (directive?.name) {
                ...
                MODULE_DIRECTIVE -> {
                    ...
                    docsRoot = findMultiModuleRoot() ?: (findModuleRoot(
                        isRoot,
                        moduleName
...
private fun KnitContext.flushTestOut(
    file: File,
    props: KnitProps,
    testName: String?,
...
fun KnitContext.withInputTextReader(
    file: File,
    type: InputFileType,
    block: InputTextReader.() -> Unit
): InputTextReader? =
